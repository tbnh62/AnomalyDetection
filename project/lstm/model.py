...
class LSTMAnomalyDetector:
    ...
    def _build_model(self):
        model = tf.keras.Sequential([
            ...
            tf.keras.layers.Masking(mask_value=-1, input_shape=(self.sequence_length, self.input_dim)),
            ...
            tf.keras.layers.RepeatVector(20),  # Collo di bottiglia
    ...
    def evaluate(self, test_data):
        ...
        mse_reference = tf.keras.losses.mean_squared_error(test_data.flatten(), predicted.flatten())
